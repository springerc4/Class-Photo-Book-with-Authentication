...
?>
<!-- Display "user deleted" message to the user -->
<html lang="en">
  <head>
    <meta charset="utf-8">
...
?>
  <body>
    <div class="alert alert-danger" role="alert">
      ...
      <p>In order to delete a user, you have to be signed in to an account.</p>
      <hr>
      <p class="mb-0">
  ...
  <body>
    <div class="card" style="width: 18rem; margin-left: 40%; margin-top: 5%;">
        ...
        <div class="card-body">
            ...
            <p class="card-text">An existing user has been successfully deleted to the roster. Happy coding!</p>
...
<?php
    ...
    $index = $_GET['index'];
    for ($i = $index; $i < count($new_array); $i++) {
